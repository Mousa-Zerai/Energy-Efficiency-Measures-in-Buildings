...
#PV generation#
    ...
    g1max = np.abs(g1max)
    global_criterion = p1 / (g1max - g1min) * (- pe_retrofit + g1max) + p2 / (g2max - g2min) * (re_cost - g2min)
